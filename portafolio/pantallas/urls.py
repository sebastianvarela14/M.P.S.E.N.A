...
urlpatterns = [
    ...
    path("coordinador_editar/<int:id>/", views.coordinador_editar, name="coordinador_editar"),    path("coordinador_agregar/", views.coordinador_agregar, name="coordinador_agregar"),
